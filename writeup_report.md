...
Training data was chosen to keep the vehicle driving on the road. I used a combination of center lane driving data, and data recovering from the left and right sides of the road.
